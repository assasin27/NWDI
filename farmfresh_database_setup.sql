-- FarmFresh E-commerce Database Setup
-- Complete SQL script to recreate the entire database from scratch
...
-- Products table (updated with freshness fields)
CREATE TABLE products (
  ...
  harvest_date DATE,
  expiry_date DATE,
  freshness_score FLOAT DEFAULT 1.0 CHECK (freshness_score >= 0.0 AND freshness_score <= 1.0),
...
INSERT INTO products (name, price, description, category, unit, image, certification, region, harvest_date, expiry_date, freshness_score, quantity) VALUES
('Fresh Tomatoes', 40.00, 'Organic red tomatoes grown locally', 'Vegetables', 'kg', 'https://source.unsplash.com/400x300/?tomatoes', 'Organic', 'Nareshwadi', '2026-03-15', '2026-03-25', 0.95, 50),
('Bananas', 30.00, 'Sweet and ripe bananas', 'Fruits', 'kg', 'https://source.unsplash.com/400x300/?bananas', 'Organic', 'Nareshwadi', '2026-03-10', '2026-03-20', 0.90, 75),
('Spinach', 25.00, 'Fresh green spinach leaves', 'Vegetables', 'kg', 'https://source.unsplash.com/400x300/?spinach', 'Organic', 'Nareshwadi', '2026-03-16', '2026-03-18', 1.00, 30),
('Carrots', 35.00, 'Crunchy orange carrots', 'Vegetables', 'kg', 'https://source.unsplash.com/400x300/?carrots', 'Organic', 'Nareshwadi', '2026-03-12', '2026-04-12', 0.85, 60),
('Apples', 80.00, 'Juicy red apples', 'Fruits', 'kg', 'https://source.unsplash.com/400x300/?apples', 'Organic', 'Nareshwadi', '2026-02-20', '2026-04-20', 0.80, 40),
('Milk', 45.00, 'Fresh cow milk', 'Dairy', 'ltr', 'https://source.unsplash.com/400x300/?milk', 'Organic', 'Nareshwadi', '2026-03-17', '2026-03-20', 0.95, 25),
('Rice', 60.00, 'Premium basmati rice', 'Grains', 'kg', 'https://source.unsplash.com/400x300/?rice', 'Organic', 'Nareshwadi', '2026-01-15', '2027-01-15', 0.90, 100),
('Potatoes', 20.00, 'Fresh potatoes', 'Vegetables', 'kg', 'https://source.unsplash.com/400x300/?potatoes', 'Organic', 'Nareshwadi', '2026-03-10', '2026-05-10', 0.88, 80),
('Onions', 30.00, 'Red onions', 'Vegetables', 'kg', 'https://source.unsplash.com/400x300/?onions', 'Organic', 'Nareshwadi', '2026-03-05', '2026-06-05', 0.85, 70),
('Eggs', 6.00, 'Farm fresh eggs', 'Dairy', 'pcs', 'https://source.unsplash.com/400x300/?eggs', 'Organic', 'Nareshwadi', '2026-03-16', '2026-03-23', 0.95, 120);
...
SELECT name, price, freshness_score FROM products LIMIT 5;

-- =====================================================
-- SETUP COMPLETE
-- =====================================================

SELECT 'FarmFresh database setup completed successfully!' as result;