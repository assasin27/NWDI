      ...
      <div className="px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="text-center rounded-xl overflow-hidden border border-green-300 bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 transition-all duration-300 hover:shadow-card hover:scale-[1.02]"
            >
              {/* Icon removed: text-only features */}
        ...
        <div className="mb-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-green-700">Fresh Fruits</h3>
            <p className="text-base text-gray-600">Handpicked from local orchards</p>
          </div>
          <div className="text-center">
            <img src={vegetablesImg} alt="Organic Vegetables" className="w-full h-48 object-cover rounded-xl shadow-lg mb-4" />
            <h3 className="text-xl font-semibold text-green-700">Organic Vegetables</h3>
            <p className="text-base text-gray-600">Chemical-free, naturally grown</p>
          </div>
          <div className="text-center">
            <img src={heroFarm} alt="Nareshwadi Farm" className="w-full h-48 object-cover rounded-xl shadow-lg mb-4" />
            <h3 className="text-xl font-semibold text-green-700">Our Farm</h3>
            <p className="text-base text-gray-600">Sustainable farming practices</p>
          </div>
        </div>
        ...
        <div className="mb-16 max-w-2xl mx-auto text-center bg-orange-50 rounded-xl p-6 shadow border border-orange-200 flex flex-col md:flex-row items-center gap-6">
          ...
          <div>
            <h3 className="text-xl font-bold text-orange-700 mb-2">Every purchase supports a cause</h3>
            <p className="text-lg text-gray-700">These products are made from waste wood and hand painted by gifted youth and students, trained in carpentry and Warli art. Your purchase helps promote this rich heritage and supports our young artists become economically self-reliant.</p>
          </div>
        </div>
        ...
        <div className="mb-16 relative">
          ...
          <div className="relative z-10">
            <h3 className="text-3xl font-bold text-center mb-6">What People Say About Us</h3>
            <div className="flex overflow-x-auto gap-6 pb-4 px-2">
              <div className="min-w-[300px] bg-white/90 backdrop-blur-sm rounded-xl shadow p-6 flex-shrink-0">
                <p className="text-lg text-gray-700 mb-4">Impressed by both the institution and the children. Very humbling and inspiring. Thank you!</p>
                <div className="text-lg font-bold text-green-700">Eric Kalali</div>
              </div>
              <div className="min-w-[300px] bg-white/90 backdrop-blur-sm rounded-xl shadow p-6 flex-shrink-0">
                <p className="text-lg text-gray-700 mb-4">The learning centre truly focussed on growing the community, rather than imposing ideals. Every time I visit, I learn something new from the children.</p>
                <div className="text-lg font-bold text-green-700">Anonymous Visitor</div>
              </div>
              <div className="min-w-[300px] bg-white/90 backdrop-blur-sm rounded-xl shadow p-6 flex-shrink-0">
                <p className="text-lg text-gray-700 mb-4">The Vocational Training at Nareshwadi helped me to become a Warli artist and taught me to stand on my feet.</p>
                <div className="text-lg font-bold text-green-700">Jayesh Dhanap</div>
              </div>
              <div className="min-w-[300px] bg-white/90 backdrop-blur-sm rounded-xl shadow p-6 flex-shrink-0">
                <p className="text-lg text-gray-700 mb-4">I am very grateful for Nareshwadi and its teachers who supported me. Now I am a lecturer in Junior college.</p>
                <div className="text-lg font-bold text-green-700">Nilam Tumbada</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16 max-w-2xl mx-auto">
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="q1">
              <AccordionTrigger className="text-lg">What makes Nareshwadi Products unique?</AccordionTrigger>
            ...
            <AccordionItem value="q2">
              <AccordionTrigger className="text-lg">Are all products organic and eco-friendly?</AccordionTrigger>
              <AccordionContent className="text-lg">
            ...
            <AccordionItem value="q3">
              <AccordionTrigger className="text-lg">How does my purchase help the community?</AccordionTrigger>
              <AccordionContent className="text-lg">
            ...
            <AccordionItem value="q4">
              <AccordionTrigger className="text-lg">How can I place a bulk or custom order?</AccordionTrigger>
              <AccordionContent className="text-lg">
            ...
            <AccordionItem value="q5">
              <AccordionTrigger className="text-lg">How do I get updates on new products?</AccordionTrigger>
              <AccordionContent className="text-lg">
        ...
        <div className="bg-muted/30 rounded-2xl p-8 lg:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <Badge className="mb-4 bg-leaf-green text-white text-base">Meet Our Farmers</Badge>
              ...
              <div className="space-y-2 mb-6">
                <div className="flex items-center gap-2">
                  <Badge variant="outline" className="text-sm">15+ Years Experience</Badge>
                  <Badge variant="outline" className="text-sm">Organic Certified</Badge>
                </div>
                <div className="flex items-center gap-2">
                  <Badge variant="outline" className="text-sm">Sustainable Farming</Badge>
                  <Badge variant="outline" className="text-sm">Local Community Leader</Badge>
                </div>
              </div>
            ...
            <div className="lg:order-first">
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -right-4 bg-harvest-gold text-soil-brown px-4 py-2 rounded-lg shadow-button">
                  <div className="text-base font-semibold">Farmer Since</div>
